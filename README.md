...
If you're reviewing this project, **you do not need to read the entire report first.**

### 1️⃣ Open the notebook

Go to:

**[`notebook/hiverAssignment.ipynb`](notebook/hiverAssignment.ipynb)**

Open it in **Google Colab**.

### 2️⃣ Add an NVIDIA API key
